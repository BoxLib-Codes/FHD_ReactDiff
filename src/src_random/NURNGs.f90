MODULE NonUniformRNGs
! A module for random number generation from the following distributions:
!
!     Distribution                    Function/subroutine name
!
!     Uniform                         random_uniform (either Marsenne-Twister or built-in generator)
...
!  parameters change, use the second function (random_binomial).

! The compilers own random number generator, SUBROUTINE RANDOM_UNIFORM(r),
...
!     random_binomial <-- A random deviate yielding the number of events
